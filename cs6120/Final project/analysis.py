...
pivot_df["improvement"] = pivot_df["baseline"] - pivot_df["GVN"]
...
summary = {
    ...
    "Unchanged": unchanged,
    "Regressed": regressed,
    "Incorrect Results (GVN)": incorrect_counts.get("incorrect", 0),
    "Missing Results (GVN)": incorrect_counts.get("missing", 0),
    "Timeout Results (GVN)": incorrect_counts.get("timeout", 0),
...
analysis_path = "./GVN_performance_analysis.csv"
...
plt.title("Improvement of GVN over baseline")
plt.xlabel("Benchmark")
plt.ylabel("Improvement")
plt.tight_layout()

plot_path = "./GVN_improvements_plot.png"
