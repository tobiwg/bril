...
pivot_df["improvement"] = pivot_df["baseline"] - pivot_df["LICM"]
...
summary = {
    ...
    "Unchanged": unchanged,
    "Regressed": regressed,
    "Incorrect Results (LICM)": incorrect_counts.get("incorrect", 0),
    "Missing Results (LICM)": incorrect_counts.get("missing", 0),
    "Timeout Results (LICM)": incorrect_counts.get("timeout", 0),
...
analysis_path = "./LICM_performance_analysis.csv"
...
plt.title("Improvement of LICM over baseline")
plt.xlabel("Benchmark")
plt.ylabel("Improvement")
plt.tight_layout()

plot_path = "./LICM_improvements_plot.png"
